...
import { Github, Mail, Send, CheckCircle, MapPin, MessageSquare } from 'lucide-react'
...
const contactDetails = [
  {
    icon: Mail,
    label: 'Email',
    value: 'vansh@warlords.dev',
    href: 'mailto:vansh@warlords.dev',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: 'github.com/warlords',
          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            ...
            <div className="rounded-2xl border border-dashed border-accent/40 bg-accent/5 p-5">
              <p className="text-xs text-muted-foreground leading-relaxed">
                ...
                and contributions — especially from psychology researchers and developers.
              </p>
            </div>
          </div>
