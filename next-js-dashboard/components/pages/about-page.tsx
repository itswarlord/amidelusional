...
const techStack = [
  {
    ...
    name: 'Gemini AI',
    description:
      "Google's frontier model handles deep semantic understanding of conversation patterns, emotions, and relational dynamics.",
  },
  {
    icon: Layers,
    name: 'LangChain',
...
const teamMembers = [
  {
    ...
    initials: 'VA',
    color: 'from-primary to-[oklch(0.52_0.16_265)]',
  },
  {
    name: 'Team Warlords',
    role: 'Hackathon Team',
    initials: 'TW',
    color: 'from-accent to-[oklch(0.52_0.16_186)]',
  },
]
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-base leading-relaxed max-w-2xl mx-auto">
            Built at a hackathon by Team Warlords — a clinical-grade AI tool that brings
          ...
          <div className="rounded-2xl border border-border/60 bg-card overflow-hidden">
            ...
            <div className="p-8 sm:p-10">
              ...
              <div className="flex flex-col gap-4 text-muted-foreground text-base leading-relaxed">
                <p>
                  Relationship health is one of the strongest predictors of overall wellbeing — yet
                ...
                <p>
                  ...
                  proven clinical frameworks — Gottman&apos;s Four Horsemen, Attachment Theory, and
                  Cognitive Behavioral principles — to score your relationship across key dimensions.
                </p>
                <p>
                  We built this specifically for <span className="text-foreground font-medium">Indian relationships</span>{' '}
        ...
        <section className="mb-16">
          ...
          <div className="mt-6 rounded-xl border border-border/60 bg-muted/40 px-6 py-4">
            <p className="text-sm text-muted-foreground leading-relaxed text-center">
              <span className="font-medium text-foreground">Custom RAG pipeline</span> — psychology
              research papers and clinical literature are embedded into Pinecone, enabling the model
              to ground every diagnosis in established academic frameworks rather than hallucinate.
              Local LLM fine-tuning ensures culturally-aware outputs.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center">
            {teamMembers.map(({ name, role, initials, color }) => (
              ...
              >
                <div
                  className={`flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br ${color} text-white font-display font-bold text-xl shadow`}
                >
                  {initials}
                </div>
